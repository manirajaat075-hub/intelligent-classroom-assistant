...
const JoinClassroom = ({ onJoin }) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (trimmedId === '1234') {
      setError('This is a Staff Access Code. Please use your Student Classroom ID.');
      return;
    }
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-6 relative overflow-hidden text-left">
          ...
          <div className="space-y-3">
            ...
            {error && (
              <motion.p 
                ...
                animate={{ opacity: 1, y: 0 }}
                className="text-[10px] font-bold text-red-500 uppercase tracking-widest ml-1 animate-pulse"
              >
                {error}
              </motion.p>
            )}
